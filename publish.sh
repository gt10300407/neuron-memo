...
if gh repo view "$REPO" >/dev/null 2>&1; then
  ...
  gh repo create "$REPO" --public --description "NEURON MEMO retro responsive memo app" >/dev/null
...
echo
echo "새 버전 직접 접속: https://${OWNER}.github.io/${REPO_NAME}/v021.html"
